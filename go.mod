...
require (
	...
	// Upgrade this once https://github.com/sourcegraph/batch-change-utils/pull/11 is merged
	github.com/sourcegraph/batch-change-utils v0.0.0-20210422111821-7868c494a73d
