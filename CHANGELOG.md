...
### Added
- New command `src debug` dumps context from Sourcegraph instance, executing common `docker` and `kubectl` cli introspection commands and writing returns to a zip archive file. [#731](https://github.com/sourcegraph/src-cli/pull/731)
