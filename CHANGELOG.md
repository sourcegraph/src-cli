...
- A new `src campaign new` command creates a campaign spec YAML file with common values prefilled to make it easier to create a new campaign. [](https://github.com/sourcegraph/src-cli/pull/XXX)
