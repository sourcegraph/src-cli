...
- `src upload` is now a top-level command, replacing `src lsif upload`. [#745](https://github.com/sourcegraph/src-cli/pull/745)
- `src upload` supports a `-gitlab-token` flag. [#721](https://github.com/sourcegraph/src-cli/pull/721)
