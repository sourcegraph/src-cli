...
func assertLSIFOutput(t *testing.T, lsifFile, expectedLSIFString string) {
	...
	if lsifFile != uploadFlags.file {
		t.Fatalf("unexpected lsifUploadFlag.file value %s, expected %s", uploadFlags.file, lsifFile)
	}
}
