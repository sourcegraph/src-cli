...
Examples:
	...
	Delete a tag from a repository:
		...
		$ src repos tags delete github.com/sourcegraph/src-cli cli

	Delete multiple tags from a repository:
		
		$ src repos tags delete github.com/sourcegraph/src-cli cli team/batchers
