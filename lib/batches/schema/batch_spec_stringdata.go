        ...
        "properties": {
          "steps": {
            "items": {
              ...
              "allOf": [{ "not": { "required": ["codingAgent"] } }, { "not": { "required": ["buildImage"] } }]
            }
          }
        }
      }
  ...
  "definitions": {
    ...
    "BuildImage": {
      ...
      "properties": {
        "run": {
          "type": "string",
          "description": "The shell command to run in the base image before committing the result as a new image."
        },
        "baseImage": {
          "type": "string",
