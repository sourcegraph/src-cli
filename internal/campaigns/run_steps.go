...
func runSteps(ctx context.Context, wc *WorkspaceCreator, repo *graphql.Repository, steps []Step, logger *TaskLogger, tempDir string, executingCallback func(string)) ([]byte, error) {
	executingCallback("Downloading archive...")
	...
	executingCallback("Initializing workspace")
	...
	executingCallback("Calculating diff...")
