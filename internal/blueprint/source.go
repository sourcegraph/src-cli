...
// ResolveBlueprintSource creates an appropriate BlueprintSource based on the
// input. Accepts either an HTTPS Git URL or a local filesystem path.
...
// ResolveRootSource creates a BlueprintSource that provides access to the
// repository root without requiring a blueprint.yaml file. Used for listing
// all blueprints in a repository.
